...
//Problem Description: ####Write a program to calculate the total salary of a person.
...
public class a67_Problem_Salary {

	public static void main(String[] args)throws Exception {
		try(Scanner sc=new Scanner(System.in)){
			System.out.println("Enter Basic Salary and Grade(A/B/C): ");
			int basic=sc.nextInt();
			String grade=sc.next();
			float hra=(float)(20.0/100)*basic;
			float da=(float)(50.0/100)*basic;
			...
			if(g=='A') {
				...
				System.out.println("Invalid input of grade!");
			}
			totalSalary=(basic + hra + da + allow - pf);
			System.out.println("The total Salary is: "+Math.round(totalSalary));
